                    ...
                    <div class="et_pb_section et_pb_section_0 et_pb_with_background et_section_regular">
                        ...
                        <div class="et_pb_row et_pb_row_0">
                            <div class="et_pb_column et_pb_column_4_4 et_pb_column_0    et_pb_css_mix_blend_mode_passthrough et-last-child">
                                ...
                                <div class="et_pb_module et_pb_text et_pb_text_0 et_pb_bg_layout_light  et_pb_text_align_left et_had_animation" style="">
                                ...
                                <div class="et_pb_module et_pb_blog_0 bloggrid et_pb_blog_grid_wrapper">
                                    <div class="et_pb_blog_grid clearfix et_pb_bg_layout_light  et_pb_text_align_justified">
                                        ...
                                        <div class="et_pb_ajax_pagination_container">
                                            <div class="et_pb_salvattore_content" data-columns="3"><div class="column size-1of3">
                                                    @foreach($news as $new)
                                                        @include('news.detail',['new' => $new])
                                                    @endforeach
                                                    </div></div><!-- .et_pb_salvattore_content --><div class="pagination clearfix">
                                            </div></div>
                                    </div>
                                </div>
                            </div>

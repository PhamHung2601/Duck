...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{ asset('vendor/landing-page/css/landing-page.min.css') }}" rel="stylesheet">
      <link rel="stylesheet" href="{{ asset('css/overview-course.css')}}" type="text/css">
  ...
  <body>
	...
	@include('landing-page.list.partials.navigation')

	@include('landing-page.list.partials.course_list')

	@include('landing-page.list.partials.course_feedback')

	@include('landing-page.list.partials.faq')

	@include('landing-page.list.partials.footer')
  </body>

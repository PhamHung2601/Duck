    ...
    <div class="landing-content">
        <div class="section-1 section-box box-bg-light">
            <div class="container-landing">
                <h2 class="title-box"><span>CUỐN SÁCH NÀY SẼ PHÙ HỢP VỚI AI?</span></h2>
        ...
        <div class="section-2 section-box box-bg-color">

            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-4" style="text-align: left">
                    <img src="https://cdnstepup.r.worldssl.net/Images/ldpHN1500/DSC9174.png"/>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="container-landing">
                        <h2 class="title-box"><span>BẠN NHẬN ĐƯỢC GÌ SAU CUỐN SÁCH TIẾNG ANH NÀY?</span></h2>
                        <div class="box-content">
                            <p>Sau khi hoàn thành cuốn sách tiếng Anh này, từ trình độ mất gốc bạn sẽ có đủ vốn từ vựng
                                để giao tiếp trong cuộc sống. Sách vở và tạp chí tiếng Anh sẽ trở nên rất dễ dàng với
                                bạn vì 1500 từ vựng tiếng Anh cơ bản này chiếm tới 80% ngôn ngữ xuất hiện trong các kênh
                                giao tiếp hàng ngày.</p>
                            <p>Việc học của bạn sau khi học cuốn sách từ vựng tiếng Anh này sẽ trở nên vô cùng đơn giản
                                vì bạn có thể bẻ khoá từ mới bằng chính văn cảnh. Bạn sẽ có thể tăng 2-3 điểm thi
                ...
                <div class="col-sm-12 col-md-4 col-lg-4" style="text-align: right">
                    <img src="https://cdnstepup.r.worldssl.net/wp-content/uploads/2020/03/ve2020.png"/>
                </div>
            </div>
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="box-content">
                            <ul>
                                ...
                                <li>
                                    <h4><strong>TRUYỆN CHÊM</strong></h4>
                                    <p>Nạp từ vựng tự nhiên qua câu chuyện và tình huống, không cần cố gắng ghi nhớ. Giống như khi học từ vựng tiếng Việt vậy. Các câu chuyện đều chuẩn văn phong giao tiếp người bản xứ và đảm bảo tính hấp dẫn, khỏi lo buồn ngủ bạn nhé.
                                        Nạp từ vựng tự nhiên qua câu chuyện và tình huống, không cần cố gắng ghi nhớ. Giống như khi học từ vựng tiếng Việt vậy. Các câu chuyện đều chuẩn văn phong giao tiếp người bản xứ và đảm bảo tính hấp dẫn, khỏi lo buồn ngủ bạn nhé.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-7">
                        <img src="https://cdnstepup.r.worldssl.net/wp-content/uploads/2020/01/43940688-0-app.png"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-7">
        ...
        <div class="section-5 section-box box-bg-light">
            <div class="container-landing">
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        <h2 class="title-box">TÁC GIẢ CUỐN SÁCH LÀ AI?</h2>
                        <div class="box-content">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <img src="https://cdnstepup.r.worldssl.net/wp-content/uploads/2020/03/ahiep.jpg"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="section-6 section-box bg-grey">
            <div class="container-landing">
                <h2 class="title-box">BẠN SẼ BỎ LỠ GÌ NẾU KHÔNG THAM GIA?</h2>
                <div class="box-content">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="box-item">
                                <div class="img-box">
                                    <img src="https://cdnstepup.r.worldssl.net/wp-content/uploads/2019/12/000_0000_Layer-5-copy-3.png"/>
                                </div>
                                <div class="text">
                                    <strong>CHIẾN BINH STEP UP HỖ TRỢ BẠN ĐẾN TRANG CUỐI CÙNG</strong>
                                    <p>Bạn có bất cứ thắc mắc nào về chuyện học tiếng Anh hay nội dung cuốn sách, Step Up sẽ giúp bạn trả lời mọi câu hỏi. Step Up đầu tư một đội ngũ chuyên viên chăm sóc khách hàng để giúp bạn học đến trang cuối cùng.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
